...
public class EditorVectores {
	...
	private static GrupoVectoresArray grupo;  // Grupo de vectores de edición
	...
	private static int comprobarGraficoEnClick( GrupoVectoresArray grupo, Point clickInicial ) {
		int vEnClick = -1;
